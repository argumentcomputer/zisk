...
use zisk_definitions::{
    ...
    SYSCALL_BLAKE2B_ROUND_ID, SYSCALL_BLAKE3F_ID, SYSCALL_BLS12_381_COMPLEX_ADD_ID,
    ...
    SYSCALL_DMA_MEMCPY_ID, SYSCALL_DMA_MEMSET_ID, SYSCALL_KECCAKF_ID, SYSCALL_POSEIDON1_ID,
