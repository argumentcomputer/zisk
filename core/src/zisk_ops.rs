...
use crate::{
    ...
    FCALL_COST, INPUT_ADDR, INTERNAL_COST, KECCAK_COST, M64, MAX_INPUT_SIZE, POSEIDON_COST,
...
define_ops! {
    ...
    (Blake3, "blake3", Blake3, BLAKE3_COST, 0xed, 128, 32, opc_blake3, op_blake3, ops_blake3),
