...
use zisk_core::{
    ...
    BINARY_E_OP_TYPE_ID, BINARY_OP_TYPE_ID, BLAKE2_OP_TYPE_ID, BLAKE3_OP_TYPE_ID, DMA_OP_TYPE_ID,
...
pub struct StaticDataBus<D> {
    ...
    pub blake3_counter: (usize, Blake3fCounterInputGen),
...
impl StaticDataBus<PayloadType> {
    ...
    pub fn new(
        ...
        blake3_counter: (usize, Blake3fCounterInputGen),
    ...
    fn route_data(
        ...
        match bus_id {
            ...
            OPERATION_BUS_ID => match data[1] as u32 {
                ...
                BLAKE3_OP_TYPE_ID => self.blake3_counter.1.process_data(
                    &bus_id,
                    data,
                    &mut MemCounterProcessor::new(self.mem_counter.1.as_mut()),
                ),
...
impl DataBusTrait<PayloadType, Box<dyn BusDeviceMetrics>> for StaticDataBus<PayloadType> {
    ...
    fn into_devices(
        ...
        let mut counters: Vec<(Option<usize>, Option<Box<dyn BusDeviceMetrics>>)> = vec![
            ...
            (Some(self.blake3_counter.0), Some(Box::new(self.blake3_counter.1))),
